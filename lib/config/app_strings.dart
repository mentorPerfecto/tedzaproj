...
const welcomeToXamp = 'Welcome to Ecommerce';
...
const xampTenantIdHeading = 'Unique Ecommerce Tenant\'s ID';
...
const copied = 'Copied';
const share = 'Share';
const joinPropertyWithXampCode = 'Please use the following code to join my property as a tenant on Ecommerce:';
const tenantValidationOnMyPropertyWithXampCode = 'Please use the following code to perform tenant validation on Ecommerce.';
